...
#### # association analysis
    myBlink=Blink(Y=myY,GD=myGD,GM=myGM,maxLoop=10,time.cal=T) # more parameters explained here[https://github.com/YaoZhou89/BLINK/blob/master/man/User%20Manual.md]
